...
def main():
    ...
    for model_subdir in models_subdirs:
        ...
        with open(os.getcwd() + "/" + temp.uut + "/" + subuut[0] + ".sp", 'w+') as uut:
            ...
            uut.write(".subckt input_" + "0" + " inb_" + "0" + " in_" + "0" + " vdd\n")
            uut.write("xpfetin_" + "0" + " in_" + "0" + " inb_" + "0" + " vdd vdd pfet l=" + fet_size + "n nfin=" + str(nfin) + "m\n")
            uut.write("xnfetin_" + "0" + " in_" + "0" + " inb_" + "0" + " gnd gnd nfet l=" + fet_size + "n nfin=" + str(nfin) + "m\n")
            uut.write(".ends\n\n")
            uut.write("xinput_" + "0" + " inb_" + "0" + " in_" + "0" + " vdd " + "input_" + "0" + "\n")

            #inputs needed to method "0"
            uut.write(".subckt " + temp.uut + "0" + " in_" + "0" + " out_" + "0" + " vdd\n")
            uut.write("$FETs" + "\n")
            uut.write("xpfet_" + "0" + " out_" + "0" + " in_" + "0" + " vdd vdd pfet l=" + fet_size + "n nfin=" + str(nfin) + "m\n")
            uut.write("xnfet_" + "0" + " out_" + "0" + " in_" + "0" + " gnd gnd nfet l=" + fet_size + "n nfin=" + str(nfin) + "m\n")
            uut.write(".ends\n\n")
            uut.write("x" + temp.uut + "0" + " in_" + "0" + " out_" + "0" + " vdd " + temp.uut + "0" + "\n")

            #inputs needed to method "0", also how many loads
            uut.write("$Output Load\n")
            uut.write(".subckt output_" + "0" + " out_" + "0" + " outb_" + "0" + " vdd\n")
            uut.write("xpfetout_" + "0" + " outb_" + "0" + " out_" + "0" + " vdd vdd pfet l=" + fet_size + "n nfin=" + str(nfin) + "m\n")
            uut.write("xnfetout_" + "0" + " outb_" + "0" + " out_" + "0" + " gnd gnd nfet l=" + fet_size + "n nfin=" + str(nfin) + "m\n")
            uut.write(".ends\n\n")
            uut.write("xoutput_" + "0" + " out_" + "0" + " outb_" + "0" + " vdd " + "output_" + "0" + "\n")
