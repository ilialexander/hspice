...
def main():
    ...
    for path, model_uut in zip(subdir_paths[1:],temp.models_subdir):
        with open(path + "/" + temp.uut + "_" + model_uut + ".sp", 'w+') as uut:
            ...
            uut.write("$FETs" + "\n")
            uut.write("xpfet" + "1" + " out in vdd vdd pfet l=" + "****size****" + " nfin=" + str(nfin) + "m\n")
            uut.write("xnfet" + "1" + " out in gnd gnd nfet l=" + "****size****" + " nfin=" + str(nfin) + "m\n\n")

            uut.write("$Output Load\n")
            uut.write("c" + "1" + " out 0 5f\n\n")

            uut.write("$Power Sources\n")
            uut.write("vdd vdd gnd " + "****ptm_source****" + "\n")
            uut.write("vin in  gnd  PULSE(0V " + "****ptm_source****" + "V 0ns 50ps 50ps 1ns 20ns)\n\n")
