...
class cam(inverter):
    ...
    def set_cells_subckts(self, subuut):
        ...
        if "hp" in subuut:
            self.spice_file.write(".subckt prec sae bl bbl \n")
            self.spice_file.write("xprec_bl bl sae vdd vdd pfet l=lg nfin=" + self.fet_nfin + "\n")
            self.spice_file.write("xprec_bbl bbl sae vdd vdd pfet l=lg nfin=" + self.fet_nfin + "\n")
        else:
    ...
    def write_uut(self, subuut):
        ...
        for outin in range(self.ser_instances):
            ...
            if "hp" in subuut:
                self.spice_file.write("xprec_" + inout + " " + "sae_" + inout + " " + "bl_" + inout + " " + "bbl_" + inout + " " + "prec\n")
            else:
    ...
    def measure_delays(self, subuut):
    ...
    def measure_power(self):
        ...
        for outin in range(self.ser_instances):
            ...
            for instance in range(self.par_instances):
                ...
                self.spice_file.write(".measure tran cam_avg_hold_power_" + inout + ins_str + " avg p(xuut_grid.xcam_" + inout + ins_str + ") from=0ns to=0.15ns\n")
                ...
                self.spice_file.write(".measure tran cam_avg_read_power_" + inout + ins_str + " avg p(xuut_grid.xcam_" + inout + ins_str + ") from=0.7ns to=0.9ns\n")
