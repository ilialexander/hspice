...
from classes.sram_lstp import sram_lstp
...
def main():
    ...
    uut_setup = ptm("sram_lstp", "nfet.pm", "pfet.pm", "1000m") # calls ptm class
    ...
    for fet_params in uut_params:
        ...
        with open(cwd + "/" + uut_setup.uut + "/" + subuut + ".sp", 'w+') as spice_file:
            ...
            subckts_modules = sram_lstp(script_params, grid_params, fet_params, sim_params)
